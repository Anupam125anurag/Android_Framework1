...
subject_text= "AUTOMATION OUTCOME: {device_model}"
msg['Subject'] = subject_text
body = "Hello, Please find the reports of Integrated Android Security test framework {device_name}." \
       "Device Details:\nAndroid Version: {android_version} \nBuild ID: {build_id}\n Device Model: {device_model} \n\n\n\nThank You."

msg.attach(MIMEText(body, 'plain'))
filename="report.html"
attachment1 = open("/home/idm/Desktop/MytcsApp1/report.html", "rb")
filename2="log.html"
attachment2 = open("/home/idm/Desktop/MytcsApp1/log.html", "rb")
filename="Report_all.txt"
attachment1 = open("/home/idm/Desktop/MytcsApp1/Report_all.txt", "rb")
